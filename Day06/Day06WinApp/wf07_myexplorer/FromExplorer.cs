...
{
    public partial class FromExplorer : Form
    {
        public FromExplorer()
        {
            InitializeComponent();
        ...
        private void FromExplorer_Load(object sender, EventArgs e)
        {
            // 현재 사용자 출력
        ...
        private void CboView_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (CboView.SelectedIndex)
            {
                ...
                //default:      // 위와 같은경우면 default는 없어도 됌
                //    LsvFolder.View = View.Details; break;
            }
        }
